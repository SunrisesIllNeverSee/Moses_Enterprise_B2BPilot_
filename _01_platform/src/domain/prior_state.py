"""PriorState — the state of the operator's work context before an interaction.

Per `03_CONNECTION_INGESTION.md` §5.6 Object 8: Captures what the operator had
already established (context, prior work, prior AI output) before submitting
the current input. Only populated with complete-interaction-telemetry-grade
sources.
...
class PriorState:
    """The state before an operator action.
