...
EVAL_FAMILIES: Dict[str, EvalFamily] = {
    ...
    "EVAL-003": EvalFamily("EVAL-003","Context Architecture","Reuse/construction patterns with provider caveats.",True,"full",["context_architecture","score_operator","detect_patterns"],["score operator","diagnose operator"],["get_operator_profile","get_diagnostics"],["3","5"],engine_types=["6.2"]),
    "EVAL-004": EvalFamily("EVAL-004","Longitudinal Movement","Metric change, stability, band movement.",True,"full",["longitudinal_movement","score_operator","replicate_finding"],["score operator"],["get_operator_profile"],["3"],engine_types=["6.4"]),
    ...
    "EVAL-009": EvalFamily("EVAL-009","Team Composition","Coverage and complementarity hypotheses.",True,"full",["team_composition","compare_teams"],["compare teams"],["get_cohort_overview"],["2"],engine_types=["6.3"]),
    "EVAL-010": EvalFamily("EVAL-010","Capability Dependency Risk","Single-point-of-failure/coverage risk.",True,"full",["dependency_risk","detect_cohort_patterns"],["diagnose cohort"],["get_diagnostics"],["5"],engine_types=["6.3"]),
    ...
    "EVAL-015": EvalFamily("EVAL-015","AI Learning Curve","Rate/shape of operator change with uncertainty.",True,"full",["learning_curve","replicate_finding","verify_intervention"],[],["verify_change"],["8"],engine_types=["6.5"]),
}
